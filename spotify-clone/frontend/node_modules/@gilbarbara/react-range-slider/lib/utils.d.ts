...
export declare function getCoordinates(e: MouseEvent | TouchEvent, lastPosition: RangeSliderPosition): RangeSliderPosition;
 ...
 */
export declare function num(value: string | number): number;
/**
